...
entry_box = Entry(font='verdans 14 bold', width=22, bd=10, justify=RIGHT, bg='#000000')
entry_box.insert(0, "O")
...
btn_number = []
for i in range(10):
    btn_number.append(Button(width=4, text=str(i), font='times 15 bold', bd=5, command=lambda x=i: enterNumber(x)))
